$(document).ready(function () {
	...
	$('tr.audio-tr').click(function (event) {
		$("#audio-src").attr("src", this.id).get(0).play();
	});
	...
	//My Files Page
	if($('[data-toggle="tooltip"]').length && window.location.pathname != "/project/Music-site/indexmusic.html") {
